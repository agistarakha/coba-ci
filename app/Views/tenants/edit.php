...
<div class="row">
    <div class="col-md-8">
        ...
        <form action="<?= base_url('tenants/' . $tenant['id'] . '/update') ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="address" name="address" rows="3"><?= old('address', $tenant['address']) ?></textarea>
            </div>
